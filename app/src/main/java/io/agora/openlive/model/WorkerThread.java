...
public class WorkerThread extends Thread {
    ...
    public final void joinChannel(final String channel, int uid) {
        ...
        ensureRtcEngineReadyLock();
       //add by longxin
        String token = mContext.getString(R.string.private_app_token);
        String cname = mContext.getString(R.string.private_app_cname);
        int uidFromXml  = Integer.parseInt(mContext.getString(R.string.private_app_uid));
        android.util.Log.v("longxin","token:"+token+"\n"+"cname:"+cname+" uidFromXml:"+uidFromXml);
        mRtcEngine.joinChannel(token, cname, "OpenLive", uidFromXml);
